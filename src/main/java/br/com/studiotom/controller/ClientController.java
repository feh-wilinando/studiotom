...
import br.com.studiotom.infra.StorageFile;
...
public class ClientController {
    ...
    public ModelAndView save(MultipartFile profileImg, @Valid Client client, BindingResult bindingResult, RedirectAttributes redirectAttributes){
        ...
        if( ! (StringUtils.isEmpty(profileImg.getOriginalFilename())) ) {
            client.setProfileImagePath(storageFile.write("profile-img", profileImg));
        }
